    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'Щось пішло не так. Потрібна допомога? https://github.com/craftdio/keeperd/issues',
            },
        },
        import_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'JSON діаграми є неправильним. Будь ласка, перевірте JSON і спробуйте ще раз. Потрібна допомога? https://github.com/craftdio/keeperd/issues',
            },
        },
        // TODO: Translate
        import_dbml_dialog: {
