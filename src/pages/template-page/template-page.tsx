        ...
        <>
            <Helmet>
                {template ? (
                    <>
                        <title>
                            {`Database schema diagram for - ${template.name} | KeepERD`}
                        </title>
                        <meta
                            name="description"
                        ...
                        <meta
                            property="og:title"
                            content={`Database schema diagram for - ${template.name} | KeepERD`}
                        />
                        <meta
                            property="og:url"
                        ...
                        <meta
                            name="twitter:title"
                            content={`Database schema for - ${template.name} | KeepERD`}
                        />
                        <meta
                    ...
                    <title>Database Schema Diagram | KeepERD</title>
                )}
            </Helmet>
            ...
            <section className="flex h-screen w-screen flex-col bg-background">
                <nav className="flex h-12 shrink-0 flex-row items-center justify-between border-b px-4">
                    ...
                    <div className="flex flex-1 justify-end">
                        <iframe
                            src={`https://ghbtns.com/github-btn.html?user=EunjinWoo&repo=chartdb&type=star&size=large&text=false`}
                            width="40"
                            height="30"
                            title="GitHub"
                        ></iframe>
