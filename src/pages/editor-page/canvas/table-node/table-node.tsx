        ...
        return (
            <TableNodeContextMenu table={table}>
                ...
                >
                    ...
                    <div
                        aria-hidden="true"
                        className="table-node-overview pointer-events-none absolute inset-0 z-20 rounded-[6px]"
                    >
                        <div
                            className="absolute inset-0 rounded-[6px] opacity-80"
                            style={{ backgroundColor: tableColor }}
                        />
                        <div
                            className="absolute inset-2 rounded border-2 opacity-50"
                            style={{
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <span className="table-node-overview-label text-center text-2xl font-black tracking-tight text-white drop-shadow-[0_2px_2px_rgba(0,0,0,0.9)]">
                                {table.name}
                            </span>
                        </div>
                    </div>
