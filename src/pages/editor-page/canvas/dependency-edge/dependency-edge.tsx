...
interface DependencyEdgeContentProps extends EdgeProps<DependencyEdgeType> {
    dependencies: DBDependency[];
}

const DependencyEdgeContent: React.FC<DependencyEdgeContentProps> = React.memo(
    ({
        dependencies,
        id,
        sourceX,
...
DependencyEdgeContent.displayName = 'DependencyEdgeContent';

export const DependencyEdge: React.FC<EdgeProps<DependencyEdgeType>> =
    React.memo((props) => {
        const { dependencies } = useChartDB();
        return <DependencyEdgeContent {...props} dependencies={dependencies} />;
    });
